function! init#quickui#main() "{{{
	...
	call quickui#menu#install('&View', [
				...
				\ ['&Translate history', 'TranslateH'],
				\ ['--', ''],
				\ ['&Filetype', 'execute "split $XDG_CONFIG_HOME/nvim/ftplugin/" . split(&filetype, ''\.'')[0] . ".vim"'],
				\ ['S&yntax', 'execute "split $XDG_CONFIG_HOME/nvim/after/syntax/" . split(&filetype, ''\.'')[0] . ".vim"'],
				\ ['--', ''],
				\ ['Li&st function', 'call quickui#tools#list_function()'],
				\ ['&Preview tag', 'call quickui#tools#preview_tag(expand("<cword>"))'],
				\ ])
	call quickui#menu#install('&Git', [
				\ ['&Git', 'G'],
				\ ['&Init', 'AsyncRun git init'],
				\ ['&View', 'Agit'],
				\ ['View &file', 'AgitFile'],
				\ ['L&og', 'Gclog!'],
	...
	call quickui#menu#install('&Snippet', [
				...
				\ ['&All', 'split $XDG_CONFIG_HOME/nvim/UltiSnips/all.snippets'],
	...
	call quickui#menu#install('&Plugins', [
				...
				\ ['H&elp', 'Leaderf help'],
				\ ['--', ''],
				\ ['&Test', 'AsyncRun gvim -u $XDG_CONFIG_HOME/nvim/test.vim'],
				\ ])
